...
<head>
  ...
  <div id="top">
	...
	<div class="hd_top_manu clearfix">
	  <ul class="clearfix">
       ...
       <!-- ********************************************************************************* -->
        <li class="hd_menu_tit" data-addclass="hd_menu_hover"><a href="ListCartServlet">我的购物车</a></li>	
	  </ul>
	</div>
    </div>
  </div>
 ...
 <!-- ********************************************************************************************** -->
   <div class="s_cart"><a href="ListCartServlet">我的购物车</a> <i class="ci-right">&gt;</i><i class="ci-count" id="shopping-amount">0</i></div>
...
<!-- ****************************************************************************************** -->
        ...
        <!-- ?????????????????????????????????????????????????????????????????????????????????????????????????????????? -->
        <div class="Ads_style">
	        <c:forEach var="good" items="${applicationScope.goodsLst }">
	        	<a href="LoadGoodsServlet?goodsId=${good.goodsId }"><img src="${good.imgPath }"  width="318"/></a>
	        </c:forEach>
        </div>
  </div>
 </div>
