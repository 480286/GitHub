    ...
    <div class="top wrapper">
        ...
        <div class="float-rt">
            <ul>
                ...
                <li><a href="">商品分类</a></li>
<!-- *********************************************************************************** -->
                <li><a href="ListCartServlet">我的购物车</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div class="clear wrapper header">
    ...
    <!-- ************************************************************************************** -->
    <div class="homecart float-rt"><a href="ListCartServlet">购物车</a></div>
</div>
<!--头部快捷栏END-->
...
<div class="sup-wid">
    ...
    <!-- ********************************************************************************* -->
        ...
        <div class="pro_detail_img float-lt">
            <div class="gallery">
                <div class="tb-booth tb-pic tb-s310"> <a href="images/01.jpg"><img src="${requestScope.good.imgPath }"  alt="展品细节展示放大镜特效" rel="images/01.jpg" class="jqzoom" /></a> </div>
        ...
        <div class="float-lt pro_detail_con">
            <div class="pro_detail_tit">${requestScope.good.goodsName }</div>
            <div class="pro_detail_ad">${requestScope.good.bak }</div>
            ...
            <div class="clear"></div>
            <div class="pro_detail_act margin-t20 fl"><span class="margin-r20">售价</span><span style="font-size:26px; font-weight:bold; color:#dd514c;" >￥${requestScope.good.price }</span></div>
            <div class="clear"></div>
            <div class="act_block margin-t5"><span>本商品可使用9999积分抵用￥9.99元</span></div>
            <form action="DetailsCartServlet" method="post">
            <div class="pro_detail_number margin-t30">
                ...
                <div class="">
                    ...
                    <i class="jia"></i> --> 
                    <input type="hidden" name="goodsId" value="${requestScope.good.goodsId }"/>
                    <input type="button" name="minus" value="-" class="combo-minus" />
                    <input type="text" name="amount" value="1" class="combo-value" />
                    <input type="button" name="plus" value="+" class="combo-plus" />
                    <span>&nbsp;盒</span> <span>（库存000盒）</span> </div>
                <div class="clear"></div>
            </div>
            <div class="guige">
...
<!-- ******************************************************************************************* -->
                    <li class="pro_detail_add">
                    	<!-- <a href="#" onclick="ShowDiv('MyDiv','fade')">加入我的货仓</a> -->
