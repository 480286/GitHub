...
<body>
	<br>
	<div width="30%" height="100%" float="left"></div>
	...
	<a href="souye?currentPage=${pf.firstPage }">首页</a>

	<a href="souye?currentPage=${pf.prePage }">上一页</a>
	...
	<a href="souye?currentPage=${pf.nextPage }">下一页</a>

	<a href="souye?currentPage=${pf.lastPage }">尾页</a>
